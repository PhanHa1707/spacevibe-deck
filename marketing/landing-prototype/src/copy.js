export const messages = {
  en: {
    ...
    feedbackIntro:
      "Tell us what broke or what Deck should do next. Accepted requests land on the board below and move across it as the work happens.",
    ...
    feedbackSent: "Thanks — it is in. It appears on the board once it has been reviewed.",
    ...
    feedbackEmptyColumn: "Nothing here yet.",
  ...
  vi: {
    ...
    feedbackTitle: "Góp ý",
    feedbackIntro:
      "Kể cho chúng tôi thứ gì đang hỏng hoặc Deck nên làm gì tiếp theo. Góp ý được duyệt sẽ lên bảng bên dưới và đi dần qua các cột theo tiến độ.",
    ...
    feedbackSent: "Cảm ơn bạn — đã nhận. Góp ý sẽ lên bảng sau khi được duyệt.",
    ...
    feedbackEmptyColumn: "Chưa có gì.",
