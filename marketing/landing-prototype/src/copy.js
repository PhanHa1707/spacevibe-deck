export const messages = {
  en: {
    ...
    feedbackTitlePlaceholder: "One line that sums it up",
    feedbackBodyLabel: "Details",
    feedbackBodyPlaceholder: "What happened, what you expected, your OS and Deck version…",
  ...
  vi: {
    ...
    feedbackCategoryIdea: "Ý tưởng",
    feedbackCategoryOther: "Khác",
    feedbackTitleLabel: "Tiêu đề",
    feedbackTitlePlaceholder: "Một dòng tóm tắt",
    feedbackBodyLabel: "Chi tiết",
    feedbackBodyPlaceholder:
      "Chuyện gì đã xảy ra, bạn mong đợi gì, hệ điều hành và phiên bản Deck…",
